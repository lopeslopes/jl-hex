...
latA1 = transpose(read_lattice_3d("data/0.0191435_bernal/latticeA1_out.dat", norm_a1+1000.0))
latB1 = transpose(read_lattice_3d("data/0.0191435_bernal/latticeB1_out.dat", norm_a1+1000.0))
latA2 = transpose(read_lattice_3d("data/0.0191435_bernal/latticeA2_out.dat", norm_a1+1000.0))
latB2 = transpose(read_lattice_3d("data/0.0191435_bernal/latticeB2_out.dat", norm_a1+1000.0))
